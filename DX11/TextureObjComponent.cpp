...
TextureObjComponent::TextureObjComponent(Game* inGame, ID3D11Device* device, ID3D11DeviceContext* context, std::vector<Vector4> points, std::vector<int> indeces, LPCWSTR inFileName, LPCWSTR inTexName, Camera* camera)
{
	game = inGame;
	...
	gameCamera = camera;
	objectPosition = Vector3::Zero + Vector3(0, 1, 0);						//установка позиции объекта
