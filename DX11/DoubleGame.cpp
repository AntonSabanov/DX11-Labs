...
HRESULT DoubleGame::PrepareRecources()
{
	...
	swapDesc1.BufferDesc.Width = appDisplay->screenWidth;						//ширина переднего буфера	
	swapDesc1.BufferDesc.Height = appDisplay->screenHeight;						//высота переднего буфера
	...
	swapDesc1.OutputWindow = appDisplay->hWnd;									//привязка к нашему окну WinApi
	...
	//	featureLevel,													//11_0
	//	1,
	//	D3D11_SDK_VERSION, &device, nullptr,														//указатель на первый поддерживаемый элемент в массиве featureLefel
	//	&context);
